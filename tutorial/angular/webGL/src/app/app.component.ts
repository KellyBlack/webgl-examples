...
import { ViewMatrixModule, Mat3, Vec3, Vec4, Mat2, Mat23, Mat4, Quat, Vec2} from './view-matrix/view-matrix.module';
...
export class AppComponent implements OnInit
{
    ...
    setupGL()
    {
        this.gl   = this.webGL.nativeElement.getContext('webgl');

        if(this.gl==null)
        {
            alert("No GL context created");
            return;
        }
  ...
  `;
    ...
    drawScene(gl, programInfo, buffers)
    {
        ...
        this.mat4.perspective(projectionMatrix,
                              fieldOfView,
                              aspect,
                              zNear,
                              zFar);
